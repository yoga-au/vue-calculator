<template>
	<div class="calculator">
		...
		<div class="numpad-container">
			...
			<button class="numpad delete" @click="deleteScreen">
			...
			<button class="numpad operator" @click="plus" :disabled="disableOperator"> + </button>
			<button class="numpad number" @click="numOne" :disabled="disable"> 1 </button>
			<button class="numpad number" @click="numTwo" :disabled="disable"> 2 </button>
			<button class="numpad number" @click="numThree" :disabled="disable"> 3 </button>
			<button class="numpad operator" @click="minus" :disabled="disableOperator"> - </button>
			<button class="numpad number" @click="numFour" :disabled="disable"> 4 </button>
			<button class="numpad number" @click="numFive" :disabled="disable"> 5 </button>
			<button class="numpad number" @click="numSix" :disabled="disable"> 6 </button>
			<button class="numpad operator" @click="multiply" :disabled="disableOperator"> x </button>
			<button class="numpad number" @click="numSeven" :disabled="disable"> 7 </button>
			<button class="numpad number" @click="numEight" :disabled="disable"> 8 </button>
			<button class="numpad number" @click="numNine" :disabled="disable"> 9 </button>
			<button class="numpad operator" @click="division" :disabled="disableOperator"> / </button>
